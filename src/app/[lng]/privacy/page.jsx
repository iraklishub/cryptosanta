      ...
      <main className="p-4 w-full h-fit flex justify-center">
        <div className="bg-slate-200 p-8 rounded-md prose prose-stone">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to My
                Site.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Country</strong> refers to: Georgia
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>To contact You:</strong> To contact You by email, related to the
          ...
          <p>
            You may contact Us to request access to or delete any personal information that You have
            provided to Us.
          </p>
          <p>
          ...
          <p>
            ...
            personally identifiable information from anyone under the age of 13 without verification
            of parental consent. If You are a parent or guardian and You are aware that Your child
